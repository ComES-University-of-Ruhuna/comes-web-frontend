    ...
    <div className={cn("relative", className)}>
      ...
      >
        <defs>
          ...
          <filter id="robotShadow" x="-20%" y="-20%" width="140%" height="140%">
            <feDropShadow
              ...
              dy="4"
              stdDeviation="4"
              floodColor={isDark ? "#1e40af" : "#003366"}
              floodOpacity="0.3"
            />
          </filter>
        ...
        <motion.g filter="url(#robotShadow)">
          <rect x="55" y="45" width="90" height="65" rx="20" fill="url(#robotBody)" />
        ...
        {/* Neck */}
        <rect x="85" y="110" width="30" height="15" fill="url(#robotBody)" />

        {/* Body */}
        <motion.g filter="url(#robotShadow)">
          <rect x="45" y="125" width="110" height="80" rx="15" fill="url(#robotBody)" />
      ...
      {[...Array(6)].map((_, i) => (
        <motion.div
          key={i}
          className={cn("absolute h-2 w-2 rounded-full", isDark ? "bg-blue-400" : "bg-comesBlue")}
          style={{
            top: `${20 + i * 15}%`,
            left: i % 2 === 0 ? "-5%" : "95%",
          }}
