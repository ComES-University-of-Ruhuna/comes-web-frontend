      ...
      <div className="space-y-2">
        ...
        <div className={cn(
          ...
          {isAdmin ? (
            ...
            <GraduationCap className={cn('w-5 h-5', isDark ? 'text-blue-400' : 'text-blue-600')} />
          )}
        </div>
        ...
        <button
          ...
          className={cn(
            'flex items-center gap-3 px-4 py-3 rounded-xl w-full transition-all text-red-500 hover:bg-red-500/10'
          )}
        >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className={cn(
              'absolute right-0 mt-2 w-72 rounded-2xl border shadow-xl overflow-hidden z-50',
              isDark 
          ...
          >
            ...
            <div className={cn(
              ...
              <p className={cn('text-xs font-medium mb-2', isDark ? 'text-gray-500' : 'text-gray-400')}>
                THEME
              </p>
