...
export const CustomCursor = () => {
  ...
  }, [handleMouseMove, handleElementHover, handleMouseEnter, handleMouseLeave, handleMouseDown, handleMouseUp]);
  ...
  return (
    <>
      ...
      <motion.div
        className={cn(
          'fixed top-0 left-0 pointer-events-none z-[9998] rounded-full blur-xl',
