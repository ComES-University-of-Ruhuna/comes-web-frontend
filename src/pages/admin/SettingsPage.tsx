...
import { Save, Globe, Bell, Lock, Palette, Database, Shield, Eye, EyeOff } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-6 lg:flex-row">
        ...
        <div
          className={cn(
            "shrink-0 rounded-2xl border p-2 lg:w-64",
        ...
        >
          ...
          {activeTab === "general" && (
            ...
            >
              <h2
                className={cn(
                  "border-b pb-4 text-xl font-semibold",
            ...
            >
              ...
              <div className="space-y-4">
                {[
                  ...
                  {
                    key: "newContactAlert",
                    label: "New Contact Alerts",
                    desc: "Get notified when someone submits a contact form",
                  },
                  {
                    key: "newSubscriberAlert",
                    label: "New Subscriber Alerts",
                    desc: "Get notified when someone subscribes to newsletter",
                  },
                  {
                    key: "eventReminders",
                    label: "Event Reminders",
                    desc: "Send reminders before upcoming events",
                  },
                ].map(({ key, label, desc }) => (
                  <div
                    key={key}
                  ...
                  >
                    ...
                    >
                      <span
                        className={cn(
                          "absolute top-1 h-6 w-6 rounded-full bg-white shadow-lg transition-transform",
                          settings.notifications[key as keyof typeof settings.notifications]
                            ? "left-7"
                            : "left-1",
                        )}
              ...
              <div className="space-y-4">
                ...
                >
                  <div className="flex items-center gap-3">
                    <Shield className={cn("h-5 w-5", isDark ? "text-gray-400" : "text-gray-500")} />
                    <div>
                      <p className={cn("font-medium", isDark ? "text-white" : "text-gray-900")}>
                ...
                <div>
                  ...
                  <input
                    ...
                    max={120}
                    className={cn(
                      "w-full max-w-xs rounded-xl border px-4 py-3 transition-colors",
                      isDark
                        ? "border-slate-700 bg-slate-800 text-white"
                        : "border-gray-200 bg-gray-50 text-gray-900",
                      "focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 focus:outline-none",
                ...
                >
                  <h3 className={cn("mb-3 font-medium", isDark ? "text-white" : "text-gray-900")}>
                    Change Password
                  </h3>
                  ...
                  <div className="grid max-w-md grid-cols-3 gap-4">
                    {["light", "dark", "system"].map((theme) => (
                      <button
                        key={theme}
                        className={cn(
                          "rounded-xl border-2 p-4 text-center capitalize transition-colors",
                          isDark
                  ...
                  <div className="flex gap-2">
                    <div className="relative flex-1">
                      <input
                        ...
                        readOnly
                        className={cn(
                          "w-full rounded-xl border px-4 py-3 pr-12 font-mono text-sm transition-colors",
                          isDark
                            ? "border-slate-700 bg-slate-800 text-white"
                            : "border-gray-200 bg-gray-50 text-gray-900",
                        )}
